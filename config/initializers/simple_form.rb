...
SimpleForm.setup do |config|
  ...
  config.default_form_class = 'contents'
  ...
  config.wrappers :vertical_multi_select, tag: 'div', class: 'my-4', error_class: 'f', valid_class: '' do |b|
    ...
    b.wrapper tag: 'div', class: 'inline-flex space-x-1' do |ba|
      ba.use(
        :input,
        class: 'flex w-auto w-auto shadow appearance-none border border-gray-300 rounded w-full \
        p-2 bg-white focus:outline-none focus:border-blue-500 text-gray-400 leading-4 \
