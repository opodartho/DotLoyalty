...
RSpec.describe '/members' do
  ...
  let(:valid_attributes) do
    attributes_for(:member).merge(store_id: create(:store).id)
  end

  let(:invalid_attributes) do
    attributes_for(:member, name: nil, store_id: nil)
  end
  ...
  describe 'PATCH /update' do
    context 'with valid parameters' do
      let(:new_attributes) do
        attributes_for(:member, name: 'Updated member name')
      end
      ...
      it 'updates the requested member' do
        ...
        member.reload
        expect(member.name).to eq('Updated member name')
      end
